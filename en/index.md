  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-left-subtitle">
        <p class="hero-subtitle">In 2015, nearly 500,000 individuals sought protection from war, conflict, and persecution, more than twice as the previous year, overwhelming Germany’s asylum system and putting its Federal Office for Migration and Refugees (BAMF) under intense pressure. 
        </p>
...
<script type="application/json" id="heroSecondaryData">
{
  ...
  "how": {
    ...
    "link": {
      "href": "/en/documents/belehrungsdokument/",
      "label": "See the internal guidelines"
    }
  },
  "risks": {
    "text": "The reliability of this tool is a major concern. In 2017, only 160 out of the 292 reports were able to confirm the country of origin. In 2018, the BAMF claimed that the recognition rate of the software was around 80 percent.This would mean that among the around 45.000 undocumented asylum seekers who gave a speech probe in 2023, roughly 6.000 would be misclassified. Technologies such as DIAS, that are used to verify asylum-seekers’ claims, recombine and reorder technology and mundane daily experiences and contribute to the continuation of neocolonial violence under the disguise of objectivity",
    "link": {
      "href": "/en/figures-stats/",
      "label": "Learn more"
    }
  }
}
